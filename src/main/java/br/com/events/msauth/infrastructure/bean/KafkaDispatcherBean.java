package br.com.events.msauth.infrastructure.bean;

import br.com.events.msauth.domain.dto.kafka.email_request.EmailChangeRequestEmailValidationEmailRequestKafkaMessage;
import br.com.events.msauth.domain.dto.kafka.email_request.EmailChangedEmailRequestKafkaMessage;
import br.com.events.msauth.domain.dto.kafka.email_request.PasswordChangeEmailValidationEmailRequestKafkaMessage;
import br.com.events.msauth.domain.dto.kafka.email_request.PersonCreationEmailRequest;
