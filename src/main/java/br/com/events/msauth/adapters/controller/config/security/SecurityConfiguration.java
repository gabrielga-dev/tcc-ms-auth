...
import br.com.events.msauth.adapters.controller.config.interceptor.TokenInterceptor;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeRequests()
            ...
            .antMatchers(HttpMethod.PATCH, "/v1/email-validation/person-creation/**").permitAll()
