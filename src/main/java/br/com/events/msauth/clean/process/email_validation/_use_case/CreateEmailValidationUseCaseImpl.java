package br.com.events.msauth.clean.process.email_validation._use_case;

import br.com.events.msauth.clean.domain.entity.EmailValidation;
import br.com.events.msauth.clean.process.email_validation._use_case.interfaces.CreateEmailValidationUseCase;
